...
public class UART implements Protocol {
    ...
    /**
     * Constructs a UART instance with the given port ID and log directory.
     *
     * @param portId The port ID associated with this UART instance.
     * @param dir The directory where logs will be stored.
     */
    public UART(int portId, String dir) {
        this.dir = dir;
     ...
     *
     * @return The name of the protocol ("UART").
     */
    @Override
